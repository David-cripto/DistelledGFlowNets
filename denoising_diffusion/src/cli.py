...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--hidden-channels", type=int, default=32, help="Base channel width of the UNet")
    parser.add_argument("--depth", type=int, default=2, help="Number of UNet resolution levels")
    parser.add_argument("--time-frequencies", type=int, default=32, help="Number of sinusoidal time frequencies")
    ...
    parser.add_argument("--beta-schedule", choices=available_beta_schedules(), default="cosine")
